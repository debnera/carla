...
#include "MyWheeledVehicleAIController.generated.h"
...
UCLASS()
class CARLA_API AMyWheeledVehicleAIController : public AAIController
{
GENERATED_BODY()
...
AMyWheeledVehicleAIController(const FObjectInitializer& ObjectInitializer);

~AMyWheeledVehicleAIController();
